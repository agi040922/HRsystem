...
const CRM_ADVISORY: Section[] = [
  ...
  {
    no: "2",
    title: "자문 이력 CRM — 상담이 타임라인으로",
    sub: "상담·회의·이메일 자동 정리",
    items: [
      "전화·메일·회의 상담 내용을 사안별 타임라인으로 자동 정리합니다.",
      "언제, 무엇을, 어떻게 자문받았는지 한눈에 추적할 수 있습니다.",
      "담당자 교체·인수인계 시에도 노무 히스토리가 그대로 이어집니다.",
    ],
  },
  {
    no: "3",
  ...
  },
  {
    no: "5",
    title: "정기 보고서 자동화",
    sub: "월간·분기 리포트를 자동 생성",
    body: "월간·분기 리포트를 자동으로 생성해 경영진 의사결정에 활용합니다. 자문 결과가 보고서로 정리되어, 자문의 효과를 눈으로 확인하고 다음 개선으로 이어갈 수 있습니다.",
  },
  {
    no: "6",
    ...
    items: [
      ...
      "‘발생 후 대응’이 아니라 ‘시스템으로 선제 관리’ — 분쟁 비용을 근본적으로 줄입니다.",
    ],
  },
  {
    no: "7",
    title: "활용 사례",
    sub: "다양한 산업군에서 검증된 운영 경험",
    items: [
      "IT 스타트업(80인) — 취업규칙 개정·입사 체크리스트 자동화로 법정 리스크 0건 유지.",
      "외국계 제조업(250인) — 산업안전보건 이행률 45% → 98%, 본사 리포트 자동화.",
      "전문 서비스(120인) — 분기 진단 리포트로 선제 개선, 노동위원회 사건 대응 완승.",
    ],
  },
]
