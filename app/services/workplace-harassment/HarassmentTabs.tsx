...
const LEGAL_UPDATES = [
  ...
  {
    icon: FileWarning,
    title: "매뉴얼 개정 — 허위·반복 신고 기준 제시",
    tag: "2026. 7. 2.",
    body: (
      <>
        뚜렷한 근거 없이 여러 차례 신고하거나 <b>허위로 신고</b>하는 행위는 징계사유가 될 수
        있습니다. 다만 근로기준법 제76조의3 제6항은 신고자에 대한 불리한 처우를 금지하면서{" "}
        <b>허위신고 예외를 두고 있지 않으므로</b>, 조사를 거치지 않은 단정과 즉각적인 징계는 그
        자체로 법 위반이 될 수 있습니다.
      </>
    ),
  },
