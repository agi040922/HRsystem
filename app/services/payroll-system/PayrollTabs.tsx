...
// 임금피크제 관련 컨설팅 — 최근 대법원 판결(2024·2026) 반영
const PEAK: Sec[] = [
  {
    no: "1",
    title: "임금피크제란 & 유형",
  ...
  {
    no: "2",
    title: "최근 판결 ① (2026) — 집단적 동의 없는 도입은 무효",
    sub: "개별 동의가 과반을 넘어도 취업규칙 불이익 변경 효력 없음",
    items: [
      "취업규칙 변경(임금피크제 도입)에 근로자들의 집단적 의사결정 방법이 수반되지 않은 이상, 개별적 동의가 과반수를 넘더라도 취업규칙 불이익 변경의 효력이 없습니다.",
      "즉, 직원 개개인에게 받은 동의서만으로는 부족하며, 근로자 과반수 노동조합(없으면 근로자 과반수)의 ‘집단적’ 동의 절차(회의 방식의 의사결정)를 거쳐야 합니다.",
      "출처 · 대법원 2026. 6. 25. 선고 2025다215010 판결(원심 서울고등법원 2025. 7. 9. 선고 2024나2017777).",
    ],
  },
  {
    no: "3",
    title: "최근 판결 ② (2024) — 무효면 퇴직금 중간정산도 무효",
    sub: "합리적 이유 없는 연령차별 + 파생 효과까지 무효",
    items: [
      "임금피크제가 연령을 이유로 한 합리적 이유 없는 차별로 효력이 없으면, 임금피크제가 유효함을 전제로 이뤄진 퇴직금 중간정산도 효력이 없습니다.",
      "무효 판단 시 임금 차액뿐 아니라 중간정산 등 파생된 처리까지 무효가 되어, 소급 리스크가 크게 확대될 수 있습니다.",
      "출처 · 대법원 2024. 7. 11. 선고 2023다213556 판결(금품청산지급 청구의 소; 원심 서울중앙지방법원 2023. 1. 10. 선고 2021나76165).",
    ],
  },
  {
    no: "4",
    title: "유효성 판단 — 절차 + 실체 모두 충족해야",
    sub: "집단적 동의(절차) × 합리적 이유(실체)",
    items: [
      "절차적 적법성 — 취업규칙 불이익 변경 시 근로자 과반의 ‘집단적 동의’가 필요하며, 개별 동의 과반으로 대체할 수 없습니다(2026 판결).",
      "실체적 적법성 — ①도입 목적의 타당성 ②실질적 임금삭감의 폭·기간 ③대상조치(감액에 상응하는 조치)의 적정성 ④감액 재원이 도입 목적에 사용되었는지를 종합해 ‘합리적 이유’를 판단합니다.",
      "정년연장형이라도 비용 절감·퇴출 목적의 과도한 감액이거나 임금총액이 도입 전보다 과도하게 줄면 무효가 될 수 있습니다.",
    ],
  },
  {
    no: "5",
  ...
  },
  {
    no: "6",
    title: "도입·운영 시 점검 사항",
    sub: "이미 운영 중이라면 무효 리스크부터 점검",
    items: [
      "취업규칙 변경 시 근로자 과반의 집단적 동의 절차를 적법하게 밟았는지 확인합니다.",
      "합리적 이유(목적·삭감 폭·대상조치·재원 사용)를 충족하는지 실체적 적법성을 점검합니다.",
      "이미 운영 중인 제도라면 무효 시 임금 차액·퇴직금 재정산 등 소급 리스크를 먼저 진단한 뒤 정비 방안을 설계해야 합니다.",
    ],
  },
]
...
export default function PayrollTabs() {
  ...
  const TABS: { key: TabKey; title: string; desc: string; icon: React.ReactNode }[] = [
    ...
    { key: "peak", title: "임금피크제 관련 컨설팅", desc: "2024·2026 대법원 판결 반영", icon: <TrendingDown className="h-6 w-6" /> },
  ]
      ...
      {active === "peak" && (
        <div className="mt-8">
          <h3 className="text-lg sm:text-xl font-bold text-gray-900">
            임금피크제, 최근 대법원 판결 반영 (2024·2026)
          </h3>
          <p className="mt-2 mb-6 text-sm sm:text-base leading-relaxed text-muted-foreground">
            최근 대법원은 <b>집단적 동의 없는 도입은 무효</b>(2026)이고, <b>합리적 이유 없는 차별로 무효면 퇴직금
            중간정산도 무효</b>(2024)라고 판단했습니다. 도입·운영의 <b>절차적·실체적 적법성</b>을 함께 점검해야 합니다.
          </p>
          <Accordion items={PEAK.map((s) => ({ no: s.no, title: s.title, summary: s.sub, body: s.body, points: s.items, open: s.open }))} />
          <p className="mt-4 text-xs leading-relaxed text-gray-400">
            출처 · 대법원 2026. 6. 25. 선고 2025다215010 판결, 대법원 2024. 7. 11. 선고 2023다213556 판결.
            도입 현황·유형은 중소벤처기업연구원(KOSI), 황경진·채희태·원용완, 「중소기업 임금피크제 현황 및 시사점」
            (KOSI 중소기업 포커스 22-09, 2022. 8. 1.)을 참고했습니다. 참고용 요약이며 개별 사안의 법적 판단을
            대체하지 않습니다.
          </p>
        </div>
      )}
