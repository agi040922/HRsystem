      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="prose dark:prose-invert max-w-none space-y-6">
          ...
          <ul className="list-disc pl-6">
            ...
            <li>
              자동수집항목: 서비스 이용 기록, 접속 로그, 쿠키, 접속 IP 정보, 기기·브라우저 정보(운영체제·브라우저 종류·화면
              크기 등), 페이지 이용기록(방문 페이지·클릭 등) — 방문·이용 분석 도구(PostHog)를 통해 웹사이트 이용 시 자동
              수집됩니다.
            </li>
          </ul>
          ...
          <p>
            법인은 웹사이트 이용현황을 분석하고 서비스를 개선하기 위하여 방문·이용 분석 도구인 PostHog를 이용하며, 이를
            위해 아래와 같이 개인정보 처리를 위탁하고 개인정보가 국외로 이전될 수 있습니다.
          </p>
          <ul className="list-disc pl-6">
            <li>수탁자(이전받는 자): PostHog Inc.</li>
            <li>이전되는 국가: 미국(United States, US 리전)</li>
            <li>이전 일시 및 방법: 이용자의 웹사이트 접속·이용 시점에 네트워크를 통한 전송</li>
            <li>이전·위탁 항목: 쿠키, 접속 IP 주소, 기기·브라우저 정보, 페이지 이용기록(방문 페이지·클릭 등)</li>
            <li>이전·위탁 목적: 웹사이트 이용현황 분석 및 서비스 개선</li>
            <li>보유·이용기간: 수집일로부터 12개월</li>
          </ul>
          <p>
            법인은 위 분석에서 정보주체를 직접 식별하는 정보를 수집하지 않고 통계·집계 형태로만 처리하며, 화면
            녹화(세션 리플레이) 기능은 사용하지 않습니다. 이용자는 브라우저 설정에서 쿠키 저장을 거부하거나 삭제하여
            분석용 정보 수집을 거부할 수 있으며, 이 경우 일부 기능 이용에 제한이 있을 수 있습니다.
          </p>
