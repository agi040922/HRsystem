      ...
      <div className="relative z-20 h-full flex items-center justify-center">
        <div className="mx-auto w-full max-w-4xl px-4 text-center pt-6 sm:pt-8 md:pt-16 lg:pt-0">
          <motion.h1
            ...
            className="break-keep text-xl font-bold tracking-tight text-white sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl mb-8 sm:mb-10 md:mb-12 leading-[1.9] sm:leading-[1.9] md:leading-[1.9] lg:leading-[1.9] xl:leading-[1.9]"  /* ⚠️ text-5xl 등 크기 유틸이 line-height 도 함께 지정한다. 반응형 단계마다 leading 을 같이 주지 않으면 그 단계에서 덮어써져 줄간격이 안 먹는다 */
          >
